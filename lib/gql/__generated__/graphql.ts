...
/** Connection between the GarmentFields_Fields type and the MediaItem type */
...
/** Input for the createGarment mutation. */
...
/** The payload for the createGarment mutation. */
export type CreateGarmentPayload = {
  __typename?: 'CreateGarmentPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
...
/** Input for the deleteGarment mutation. */
...
/** The payload for the deleteGarment mutation. */
export type DeleteGarmentPayload = {
  __typename?: 'DeleteGarmentPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
/** The Garment type */
export type Garment = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfGarmentFields & {
  __typename?: 'Garment';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<GarmentToGarmentConnection>;
  ...
  /** Fields of the GarmentFields ACF Field Group */
  garmentFields?: Maybe<GarmentFields>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  garmentId: Scalars['Int']['output'];
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the garments object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the garments object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
   ...
   */
  parent?: Maybe<GarmentToParentConnectionEdge>;
  /** The password for the garments object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the Garment type and the Garment type */
  preview?: Maybe<GarmentToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The Garment type */
export type GarmentAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Garment type */
export type GarmentContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The Garment type */
export type GarmentEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Garment type */
export type GarmentEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Garment type */
export type GarmentTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** A paginated collection of Garment Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of Garment Nodes */
export type GarmentConnection = {
  /** A list of edges (relational context) between RootQuery and connected Garment Nodes */
  edges: Array<GarmentConnectionEdge>;
  /** A list of connected Garment Nodes */
  nodes: Array<Garment>;
  /** Information about pagination in a connection. */
  pageInfo: GarmentConnectionPageInfo;
};

/** Represents a connection to a Garment. Contains both the Garment Node and metadata about the relationship. */
export type GarmentConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected Garment Node */
  node: Garment;
};

/** Pagination metadata specific to &quot;GarmentConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;GarmentConnectionEdge&quot; Nodes. */
export type GarmentConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Identifier types for retrieving a specific Garment. Specifies which unique attribute is used to find an exact Garment. */
export type GarmentIdType =
  /** Identify a resource by the Database ID. */
  | 'DATABASE_ID'
  /** Identify a resource by the (hashed) Global ID. */
  | 'ID'
...
/** Connection between the Garment type and the Garment type */
export type GarmentToGarmentConnection = Connection & GarmentConnection & {
  __typename?: 'GarmentToGarmentConnection';
  /** Edges for the GarmentToGarmentConnection connection */
  edges: Array<GarmentToGarmentConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Garment>;
  /** Information about pagination in a connection. */
  pageInfo: GarmentToGarmentConnectionPageInfo;
};

/** An edge in a connection */
export type GarmentToGarmentConnectionEdge = Edge & GarmentConnectionEdge & {
  __typename?: 'GarmentToGarmentConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Pagination metadata specific to &quot;GarmentToGarmentConnection&quot; collections. Provides cursors and flags for navigating through sets of GarmentToGarmentConnection Nodes. */
export type GarmentToGarmentConnectionPageInfo = GarmentConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'GarmentToGarmentConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Garment type and the Garment type */
export type GarmentToParentConnectionEdge = Edge & GarmentConnectionEdge & OneToOneConnection & {
  __typename?: 'GarmentToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Garment type and the Garment type */
export type GarmentToPreviewConnectionEdge = Edge & GarmentConnectionEdge & OneToOneConnection & {
  __typename?: 'GarmentToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Garment;
...
export type RootMutation = {
  ...
  /** The createGarment mutation */
  createGarment?: Maybe<CreateGarmentPayload>;
  ...
  /** The deleteGarment mutation */
  deleteGarment?: Maybe<DeleteGarmentPayload>;
  ...
  /** The updateGarment mutation */
  updateGarment?: Maybe<UpdateGarmentPayload>;
...
/** The root mutation */
export type RootMutationCreateGarmentArgs = {
...
/** The root mutation */
export type RootMutationDeleteGarmentArgs = {
...
/** The root mutation */
export type RootMutationUpdateGarmentArgs = {
...
/** The root entry point into the Graph */
export type RootQueryGarmentArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<GarmentIdType>;
};


/** The root entry point into the Graph */
export type RootQueryGarmentByArgs = {
  garmentId?: InputMaybe<Scalars['Int']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
...
/** The root entry point into the Graph */
export type RootQueryGarmentsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToGarmentConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the Garment type */
export type RootQueryToGarmentConnection = Connection & GarmentConnection & {
  __typename?: 'RootQueryToGarmentConnection';
  /** Edges for the RootQueryToGarmentConnection connection */
  edges: Array<RootQueryToGarmentConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Garment>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToGarmentConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToGarmentConnectionEdge = Edge & GarmentConnectionEdge & {
  __typename?: 'RootQueryToGarmentConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Garment;
...
/** Pagination metadata specific to &quot;RootQueryToGarmentConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToGarmentConnection Nodes. */
export type RootQueryToGarmentConnectionPageInfo = GarmentConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToGarmentConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToGarmentConnection connection */
export type RootQueryToGarmentConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Input for the updateGarment mutation. */
...
/** The payload for the updateGarment mutation. */
export type UpdateGarmentPayload = {
  __typename?: 'UpdateGarmentPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  garment?: Maybe<Garment>;
...
/** Provides access to fields of the &quot;GarmentFields&quot; ACF Field Group via the &quot;garmentFields&quot; field */
export type WithAcfGarmentFields = {
  /** Fields of the GarmentFields ACF Field Group */
  garmentFields?: Maybe<GarmentFields>;
};
